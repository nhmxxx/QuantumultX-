...
<style type="text/css">
    ...
    #jmanls_player { position:absolute; width:98%; left:1%; height:96%; top:2%; display:block; opacity:0.85; background:#000 url(https://greasyfork.s3.us-east-2.amazonaws.com/odzn6d9sltx0utpy7dmb2hnz5mek) center no-repeat !important; background-size:15% !important;}
  ...
  <div id="jmwin" class="jmanls_win jmanls_winbk">
    <div id="jmmenu" class="jmanls_menu">
      ...
      <div id="jmzs" style="background-image:url(https://s1.aigei.com/src/img/png/2c/2cf33a978e7d4b1d858b3157d8b80461.png?imageMogr2/auto-orient/thumbnail/!237x237r/gravity/Center/crop/237x237/quality/85/&e=1735488000&token=P7S2Xpzfz11vAkASLTkfHN7Fw-oOZBecqeJaxypL:7hpftpgvasbuAqQ2vzwTE4nkOQM=);">扫码装</div>
...
onclick="jmhome.style.display='none';jmhm4.style.display=jmqr.style.display='block';">脚本</div>
      ...
      <div id="jmh6" style="display:none;background-size:49%;background-image:url(https://gitee.com/Jones_Miller/als/raw/master/Pic/Window/anleshi.png);">解析</div>
  ...
  function jmnightandverlog () {
    ...
    for(var i=0;i<jmbsbknight.length;i++) {
        jmbsbknight[i].style.backgroundImage='url(https://gitee.com/Jones_Miller/als/raw/master/Pic/anleshi.png), linear-gradient(to left top, rgb(204, 0, 0), rgb(137, 22, 23), rgb(25, 32, 107), rgb(137, 22, 23), rgb(25, 32, 107), rgb(137, 22, 23), rgb(204, 0, 0))';
      }
    ...
    function jmals_lightmode () {
      for(var i=0;i<jmbsbknight.length;i++) {
        jmbsbknight[i].style.backgroundImage='url(https://gitee.com/Jones_Miller/als/raw/master/Pic/anleshi.png),linear-gradient(to top left,#9198e5,#9198e5,#e66465,#9198e5)';
      }
      for(var i=0;i<jmbs.length;i++) {
